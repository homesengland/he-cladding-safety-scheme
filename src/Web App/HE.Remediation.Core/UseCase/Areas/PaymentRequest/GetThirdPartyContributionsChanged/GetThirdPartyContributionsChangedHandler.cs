...
public class GetThirdPartyContributionsChangedHandler : IRequestHandler<GetThirdPartyContributionsChangedRequest, GetThirdPartyContributionsChangedResponse>
{
    ...
    public async Task<GetThirdPartyContributionsChangedResponse> Handle(GetThirdPartyContributionsChangedRequest request, CancellationToken cancellationToken)
    {
