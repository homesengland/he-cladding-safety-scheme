...
public class GetThirdPartyContributionsChangedHandler : IRequestHandler<GetThirdPartyContributionsChangedRequest, GetThirdPartyContributionsChangedResponse>
{
    ...
    public GetThirdPartyContributionsChangedHandler(IApplicationDataProvider applicationDataProvider,
    ...
    public async ValueTask<GetThirdPartyContributionsChangedResponse> Handle(GetThirdPartyContributionsChangedRequest request, CancellationToken cancellationToken)
    {
        ...
        return new GetThirdPartyContributionsChangedResponse
        {
