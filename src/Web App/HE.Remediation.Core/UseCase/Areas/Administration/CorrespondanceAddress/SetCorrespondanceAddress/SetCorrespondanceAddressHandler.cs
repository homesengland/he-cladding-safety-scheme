...
public class SetCorrespondanceAddressHandler : IRequestHandler<SetCorrespondanceAddressRequest>
{
    private readonly IApplicationDataProvider _adc;
    private readonly IDbConnectionWrapper _db;
    private readonly IUserService _userService;

    public SetCorrespondanceAddressHandler(IApplicationDataProvider adc, IDbConnectionWrapper db, IUserService userService)
    {
        _adc = adc;
        _db = db;
    ...
    public async Task<Unit> Handle(SetCorrespondanceAddressRequest request, CancellationToken cancellationToken)
    {
