...
public class GetHasAppliedForBuildingControlHandler : IRequestHandler<GetHasAppliedForBuildingControlRequest, GetHasAppliedForBuildingControlResponse>
{
    ...
    public async ValueTask<GetHasAppliedForBuildingControlResponse> Handle(GetHasAppliedForBuildingControlRequest request, CancellationToken cancellationToken)
    {
