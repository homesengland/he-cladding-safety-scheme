...
{
    [HtmlTargetElement("task-status-inline-badge")]
    public class TaskStatusInlineBadgeTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.SetAttribute("class", $"govuk-tag inline-task__tag {GetCssClass(TaskStatus)}");
