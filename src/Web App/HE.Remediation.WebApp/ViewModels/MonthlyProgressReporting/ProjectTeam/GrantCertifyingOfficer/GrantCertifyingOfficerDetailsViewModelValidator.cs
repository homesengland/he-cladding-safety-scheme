...
public class GrantCertifyingOfficerDetailsViewModelValidator : AbstractValidator<GrantCertifyingOfficerDetailsViewModel>
{
    public GrantCertifyingOfficerDetailsViewModelValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
        ...
        RuleFor(x => x.PrimaryContactNumber)
            ...
            .MaximumLength(150)
            .WithMessage("Primary Contact Number cannot exceed 150 characters");
