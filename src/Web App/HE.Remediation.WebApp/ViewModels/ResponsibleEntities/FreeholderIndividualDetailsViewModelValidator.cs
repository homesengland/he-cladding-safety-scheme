...
{
    public class FreeholderIndividualDetailsViewModelValidator : AbstractValidator<FreeholderIndividualDetailsViewModel>
    {
        public FreeholderIndividualDetailsViewModelValidator()
        {
