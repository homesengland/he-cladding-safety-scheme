...
public class GetAppointedOtherMembersTests
{
    ...
    private readonly GetAppointedOtherMembersHandler _handler;
    ...
    public async Task Handler_Returns_Data_From_DB()
    {
        ...
        //// Act
        var result = await _handler.Handle(GetAppointedOtherMembersRequest.Request, CancellationToken.None);
